...
const GroupExercises = () => {
  ...
  return (
    <>
            ...
            <Card>
              <CardContent>
                ...
                <Typography>One of the first things candidates might be faced with at their assessment centre is an
                  icebreaker exercise. Typically a candidate will be asked to spend 5-10 minutes finding about the
                  person next to them and then tell the rest of the group about that person. This is a good way to get
                  candidates chatting to each other, and for the group to feel more familiar with everyone. You may also
                  be asked to&quot;tell the group something about yourself which not many people
                  know&ldquo; or &quot;tell the group something interesting about yourself&ldquo; as a different
                  icebreaker. This is a good time to project on other candidates that you&apos;re a friendly
                  approachable person to talk to, because you want them on your side during the exercises.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
            ...
            <Card>
              <CardContent>
                ...
                <Typography>In some assessment centre group activities, candidates are assigned roles, such
                  ...
                  these cases make sure you stick to your role and try to negotiate the best outcome for your character.
                  At some point in the real job you will inevitably have to fight for a view not necessarily held by
                  you. This assessment centre exercise is designed to measure how good you are at this. If the exercise
                  does not stipulate specific roles to individuals, be careful not to tell other candidates what role
                  they should adopt. Instead try &quot;does anyone have any strong feelings about being the
                  presenter&ldquo; and wait for volunteers. It is poor leadership to assign roles to people before you
                  have any idea of their skills, so avoid it.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
      ...
      <Box sx={{ m: 5 }}>
        <PageFooter pageComplete="group_exercises" />
      </Box>
    </>
  );
};
