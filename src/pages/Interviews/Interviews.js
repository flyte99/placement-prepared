        ...
        <Box sx={{ m: 5 }}>
          <Grid container spacing={6} wrap="wrap">
            <Card className="nerves-card">
              ...
              <Divider />
              <CardContent>
                <Typography>Start by reflecting on what happens when you get nervous? Does your heart beat faster, palms
            ...
            <Card className="nerves-card">
              ...
              <CardContent>
                <Typography>Focus on your body can help you feel more in control and it’s possible to relieve some
                  physiological symptoms. Ideas include practicing slowing your breathing (e.g. in for 3, hold for 2,
                  out for 3), running cool water over your wrists to cool your body temperature before the interview,
                  taking a pause for a deep breath before you answer a question, and focusing on the feeling of the
                  chair against your back (a good way of making sure your lungs have room for those deep breaths). Try
                  noticing the pressure of your feet on the ground (literally making you feel a little more grounded).
                </Typography>
              </CardContent>
            </Card>
            <Card className="nerves-card">
              ...
              <CardContent>
                <Typography>Write down the negative thoughts that plague you about/during interviews. If your best
                  friend was thinking like this, what would you say to them? Write positive equivalents down to balance
                  things out. Reading about unhelpful thinking styles can be useful here if your thoughts are fuelling
                  anxiety.
                </Typography>
              </CardContent>
            </Card>
            <Card className="nerves-card">
              ...
              <Divider />
              <CardContent>
                <Typography>Take 5 minutes and visualise how you would feel if the interview went well. What would it be
                  like during the interview? How would you feel? How would you feel afterwards? Make the image colourful
            ...
            <Card className="nerves-card">
              ...
              <Divider />
              <CardContent>
                <Typography>Familiarity with your material and the experience of being interviewed can reduce anxiety.
                  This means that every interview you do, you’ll become more familiar with the process and thus
                  regardless of the outcome, that’s a valuable experience and an investment in your future
                </Typography>
              </CardContent>
            </Card>
          </Grid>
